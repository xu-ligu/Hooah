package com.xlg.vitamiodemo.media;
...
public class CustomMediaController extends MediaController {
    ...
    private ImageButton rainlenButton;
    ...
    protected View makeControllerView() {
        ...
        pauseButton=(ImageButton)v.findViewById(getResources().getIdentifier("pause_button", "id", context.getPackageName()));
        pauseButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if(VideoActivity.isOnPause){
                    pauseButton.setImageResource(R.drawable.pause);
                    VideoActivity.isOnPause=false;
                }else{
                    pauseButton.setImageResource(R.drawable.resume);
                    VideoActivity.isOnPause=true;
                }

                Log.d("23","看见pause被按下");
            }
        });
        rainlenButton=(ImageButton)v.findViewById(getResources().getIdentifier("mediacontroller_favorite", "id", context.getPackageName()));
        rainlenButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if(VideoActivity.isRainline){
                    VideoActivity.isRainline=false;
                    rainlenButton.setImageResource(R.drawable.downrain);
                }else{
                    VideoActivity.isRainline=true;
                    rainlenButton.setImageResource(R.drawable.rain);
                }
            }
        });
